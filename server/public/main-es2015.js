...
let AddCourseComponent = class AddCourseComponent {
    constructor(fb, dialogRef, { username }, courseService, alertService) {
        this.fb = fb;
...
/* harmony import */ var ng2_search_filter__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ng2-search-filter */ "./node_modules/ng2-search-filter/ng2-search-filter.js");
...
let AuthenticationService = class AuthenticationService {
    ...
    login(username, password) {
        return this.http.post(`${_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].gatewayurl}/auth/login`, { username, password })
...
let CourseService = class CourseService {
    ...
    bookCourses(id, username, mentorname) {
