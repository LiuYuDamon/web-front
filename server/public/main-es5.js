...
/***/ "./node_modules/raw-loader/index.js!./src/app/add-course/add-course.component.html":
/*!********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/add-course/add-course.component.html ***!
  \********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<h2 mat-dialog-title>Create Course</h2>\n\n\n<mat-dialog-content [formGroup]=\"form\">\n\n    <mat-grid-list cols=\"2\" rowHeight=\"60px\">\n\n\n            <input formControlName=\"mentorName\" type=\"hidden\">\n        <mat-grid-tile>\n    <mat-form-field style=\"width: 205px;\">\n\n        <input matInput\n                placeholder=\"Course Name\"\n               formControlName=\"name\">\n\n    </mat-form-field>\n    </mat-grid-tile>\n\n    <mat-grid-tile>\n    <mat-form-field style=\"width: 205px;\">\n\n        <input matInput\n        placeholder=\"Skill\"\n       formControlName=\"skill\">\n\n    </mat-form-field>\n    </mat-grid-tile>\n\n    <mat-grid-tile>\n    <mat-form-field>\n\n        <input matInput [matDatepicker]=\"startDatepicker\" placeholder=\"Start Time\"\n            formControlName=\"startAt\">\n\n        <mat-datepicker-toggle matSuffix\n                               [for]=\"startDatepicker\">\n\n        </mat-datepicker-toggle>\n\n        <mat-datepicker #startDatepicker></mat-datepicker>\n\n    </mat-form-field>\n    </mat-grid-tile>\n    <mat-grid-tile>\n    <mat-form-field>\n\n        <input matInput [matDatepicker]=\"endDatepicker\" placeholder=\"End Time\"\n            formControlName=\"endAt\">\n\n        <mat-datepicker-toggle matSuffix\n                               [for]=\"endDatepicker\">\n\n        </mat-datepicker-toggle>\n\n        <mat-datepicker #endDatepicker></mat-datepicker>\n\n    </mat-form-field>\n    </mat-grid-tile>\n    <mat-grid-tile>\n    <mat-form-field style=\"width: 205px;\">\n\n        <input matInput\n        placeholder=\"Fee\"\n       formControlName=\"fee\">\n\n    </mat-form-field>\n    </mat-grid-tile>\n    <mat-grid-tile>\n    <mat-form-field style=\"width: 205px;\">\n\n        <input matInput placeholder=\"Description\"\n            formControlName=\"description\">\n\n    </mat-form-field>\n    </mat-grid-tile>\n\n  </mat-grid-list>\n</mat-dialog-content>\n\n<mat-dialog-actions align=\"end\">\n\n    <button mat-button mat-dialog-close\n            (click)=\"close()\">\n        Cancel\n    </button>\n\n    <button [disabled]=\"loading\" [disabled]=\"!form.valid\" mat-button cdkFocusInitial\n            (click)=\"save()\">\n        Save\n    </button>\n\n</mat-dialog-actions>\n"
...
module.exports = ".mat-form-field {\n  display: block;\n}\n\ntextarea {\n  height: 30px;\n  resize: vertical;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _service_course_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../service/course.service */ "./src/app/service/course.service.ts");
...
var AddCourseComponent = /** @class */ (function () {
    function AddCourseComponent(fb, dialogRef, _a, courseService, alertService) {
        ...
        this.form = fb.group({
            ...
            description: [''],
            startAt: [moment__WEBPACK_IMPORTED_MODULE_4__(), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            endAt: [moment__WEBPACK_IMPORTED_MODULE_4__(), _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
    ...
    AddCourseComponent.prototype.save = function () {
        var _this = this;
        if (this.form.valid) {
            var course = {
    ...
    AddCourseComponent.prototype.close = function () {
    ...
    AddCourseComponent.ctorParameters = function () { return [
        ...
        { type: _service_course_service__WEBPACK_IMPORTED_MODULE_5__["CourseService"] },
    ...
    AddCourseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./add-course.component.html */ "./node_modules/raw-loader/index.js!./src/app/add-course/add-course.component.html"),
            styles: [__webpack_require__(/*! ./add-course.component.css */ "./src/app/add-course/add-course.component.css")]
        }),
...
var AlertComponent = /** @class */ (function () {
    function AlertComponent(alertService, snackBar) {
        this.alertService = alertService;
        ...
        this.subscription = this.alertService.getAlert()
            ...
            switch (message && message.type) {
                case 'success':
                    ...
                    _this.snackBar.open(message.text, 'close', {
                        duration: 2000,
                    });
                    break;
                case 'warn':
...
/* harmony import */ var _add_course_add_course_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./add-course/add-course.component */ "./src/app/add-course/add-course.component.ts");
/* harmony import */ var _helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./helpers/jwt.interceptor */ "./src/app/helpers/jwt.interceptor.ts");
/* harmony import */ var _helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./helpers/error.interceptor */ "./src/app/helpers/error.interceptor.ts");
/* harmony import */ var _course_list_course_list_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./course-list/course-list.component */ "./src/app/course-list/course-list.component.ts");
...
/* harmony import */ var _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./user-list/user-list.component */ "./src/app/user-list/user-list.component.ts");
...
/* harmony import */ var _angular_material_badge__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! @angular/material/badge */ "./node_modules/@angular/material/esm5/badge.es5.js");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _add_course_add_course_component__WEBPACK_IMPORTED_MODULE_25__["AddCourseComponent"],
                _course_list_course_list_component__WEBPACK_IMPORTED_MODULE_28__["CourseListComponent"],
                _user_list_user_list_component__WEBPACK_IMPORTED_MODULE_31__["UserListComponent"]
            ],
            imports: [
            ...
            providers: [_angular_material_datepicker__WEBPACK_IMPORTED_MODULE_19__["MatDatepickerModule"],
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _helpers_jwt_interceptor__WEBPACK_IMPORTED_MODULE_26__["JwtInterceptor"], multi: true },
                { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HTTP_INTERCEPTORS"], useClass: _helpers_error_interceptor__WEBPACK_IMPORTED_MODULE_27__["ErrorInterceptor"], multi: true }],
            bootstrap: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"]],
            entryComponents: [_add_course_add_course_component__WEBPACK_IMPORTED_MODULE_25__["AddCourseComponent"]]
        })
    ], AppModule);
    return AppModule;
}());
...
module.exports = ".toolbar-spacer {\n  flex: 1 1 auto;\n}\n.toolbar-button-row button,\n.toolbar-button-row a {\n  margin-right: 8px;\n}\n.toolbar-search {\n  width: 150px;\n  margin-left: 15px;\n  font-size: 15px;\n}\n.toolbar-search mat-form-field {\n  margin-right: 15px;\n}\n.user-name {\n  font-size: larger;\n  margin-right: 10px;\n}\n.toolbar-mentor {\n  margin-left: 15px;\n}\n.mat-toolbar-icon {\n  margin-top: auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _add_course_add_course_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../add-course/add-course.component */ "./src/app/add-course/add-course.component.ts");
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(authenticationService, router, dialog) {
        this.authenticationService = authenticationService;
        this.router = router;
        this.dialog = dialog;
    ...
    HomeComponent.prototype.addCourseDialog = function () {
        ...
        this.dialog.open(_add_course_add_course_component__WEBPACK_IMPORTED_MODULE_5__["AddCourseComponent"], dialogConfig);
...
module.exports = ".spinner {\n  margin: auto;\n  margin-top: 200px;\n}\n.course-card {\n  width: 100%;\n  /* height: 200px; */\n  margin: 20px 10px;\n}\n.course-actions {\n  text-align: right;\n}\n.label {\n  color: blueviolet;\n  margin-right: 10px;\n}\n.text-inside-grid {\n  position: absolute;\n  left: 5px;\n}\n.mat-header-spacer {\n  flex: 1 1 auto;\n}\n\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var MentorListComponent = /** @class */ (function () {
    function MentorListComponent(courseservice, alertService) {
        this.courseservice = courseservice;
        this.alertService = alertService;
    }
    MentorListComponent.prototype.ngOnInit = function () {
        this.getCourses();
    };
    MentorListComponent.prototype.getCourses = function () {
        var _this = this;
        this.showCourse = true;
        this.courseservice.findCourses().subscribe(function (courses) {
            // tslint:disable-next-line:no-string-literal
            if (courses['code'] === 200) {
                // tslint:disable-next-line:no-string-literal
                _this.courses = courses['data'];
                _this.showCourse = false;
            }
        }, function (error) {
            _this.alertService.error(error);
            _this.showCourse = false;
    ...
    MentorListComponent.ctorParameters = function () { return [
...
/* harmony import */ var _user_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./user.service */ "./src/app/service/user.service.ts");
...
var AuthenticationService = /** @class */ (function () {
    function AuthenticationService(http, userservice, router) {
        this.http = http;
    ...
    AuthenticationService.prototype.login = function (username, password) {
        var _this = this;
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_7__["environment"].gatewayurl + "/auth/login", { username: username, password: password })
...
var CourseService = /** @class */ (function () {
    ...
    CourseService.prototype.addCourse = function (course) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/addcourse", course);
    };
    CourseService.prototype.addRate = function (rate) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/addrate", rate);
    };
    CourseService.prototype.findCourses = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/mentor/list");
    };
    CourseService.prototype.searchCourses = function () {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/mentor/searchcourse");
    };
    CourseService.prototype.bookCourses = function (id, username, mentorname) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/mentor/book?id=" + id + "&username=" + username + "&mentorname=" + mentorname);
    };
    CourseService.prototype.findUserCourses = function (progress, username) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/course/api/v1/user/list?progress=" + progress + "&username=" + username);
    };
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.addUser = function (user) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/account/api/v1/add", user);
    };
    UserService.prototype.findUser = function (username) {
        return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].gatewayurl + "/account/api/v1/query?username=" + username);
    };
...
module.exports = ".main {\n  width: 95%;\n  margin: auto;\n}\n\n.spinner {\n  margin: auto;\n  margin-top: 200px;\n}\n\n.course-card {\n  width: 100%;\n  /* height: 200px; */\n  margin: 20px 10px;\n}\n\n.course-actions {\n  text-align: right;\n  margin-right: 10px;\n}\n\n.label {\n  color: blueviolet;\n  margin-right: 10px;\n}\n\n.text-inside-grid {\n  position: absolute;\n  left: 5px;\n}\n\n.mat-header-spacer {\n  flex: 1 1 auto;\n}\n\n.action-spacer {\n  flex: 1 1 auto;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var UserListComponent = /** @class */ (function () {
    function UserListComponent(courseservice, alertService) {
        this.courseservice = courseservice;
        this.alertService = alertService;
        this.loading = false;
    }
    ...
    UserListComponent.prototype.searchCourses = function () {
        var _this = this;
        this.showCourse = true;
        this.courseservice.searchCourses().subscribe(function (courses) {
            // tslint:disable-next-line:no-string-literal
            if (courses['code'] === 200) {
                // tslint:disable-next-line:no-string-literal
                _this.courses = courses['data'];
                ...
                _this.showCourse = false;
                // tslint:disable-next-line:no-string-literal
                _this.alertService.warn(courses['message']);
            }
        }, function (error) {
            _this.alertService.error(error);
            _this.showCourse = false;
    ...
    UserListComponent.prototype.vote = function () {
        console.log('vote');
    };
    UserListComponent.prototype.book = function (id, mentor) {
        var _this = this;
        this.loading = true;
        this.username = JSON.parse(localStorage.getItem('currentUser')).username;
        this.courseservice.bookCourses(id, this.username, mentor).subscribe(function (data) {
            // tslint:disable-next-line:no-string-literal
            if (data['code'] === 200) {
                // tslint:disable-next-line:no-string-literal
                _this.alertService.success(data['message']);
    ...
    UserListComponent.prototype.selectCourseClick = function (tab) {
        var _this = this;
        this.username = JSON.parse(localStorage.getItem('currentUser')).username;
        if (tab.index === 0) {
            this.searchCourses();
            ...
            this.showCourse = true;
            this.courseservice.findUserCourses(tab.index, this.username).subscribe(function (data) {
                // tslint:disable-next-line:no-string-literal
                if (data['code'] === 200) {
                    // tslint:disable-next-line:no-string-literal
                    _this.showCourse = false;
                    ...
                    _this.showCourse = false;
                    // tslint:disable-next-line:no-string-literal
                    _this.alertService.warn(data['message']);
                }
            }, function (error) {
                _this.showCourse = false;
                _this.alertService.error(error);
...
var UserLoginComponent = /** @class */ (function () {
    function UserLoginComponent(router, route, alertService, authenticationService) {
        var _this = this;
        this.router = router;
        this.route = route;
        this.alertService = alertService;
    ...
    UserLoginComponent.prototype.login = function (loginFormValue) {
        var _this = this;
        if (this.loginForm.valid) {
            ...
            this.authenticationService.login(loginFormValue.email, loginFormValue.password)
                ...
                _this.alertService.error('Username or Password invalid');
                _this.loading = false;
            });
        }
    };
...
var UserSignupComponent = /** @class */ (function () {
    function UserSignupComponent(userService, router, alertService, authenticationService) {
        var _this = this;
        this.userService = userService;
        this.router = router;
        this.alertService = alertService;
    ...
    UserSignupComponent.prototype.addUser = function (userFormValue) {
        var _this = this;
        if (this.userForm.valid) {
            ...
            this.userService.addUser(user)
                ...
                // tslint:disable-next-line:no-string-literal
                if (data['code'] === 202) {
                    _this.alertService.warn('Account exist');
                    _this.loading = false;
                }
                else {
...
module.exports = __webpack_require__(/*! C:\Users\YuLiu\Desktop\sba\web-front\src\main.ts */"./src/main.ts");
